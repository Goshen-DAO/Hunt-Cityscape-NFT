...
const Navbar: React.FC<NavbarProps> = () => {
  ...
  useEffect(() => {
    ...
    if (!isToastShown) {
      toast.info(
        "Make sure to access the correct link https://hunt.goshendao.com to avoid phishing risks.",
        {
          position: "top-center",
  ...
  return (
    ...
    >
      ...
      >
        <Link href={"/"}>
          <Heading>Hunt Cityscape</Heading>
        </Link>
        {isSmallerScreen ? (
          <IconButton
  ...
  <Button onClick={disconnect} colorScheme="red" mt={{ base: 5, md: 0 }}>
    Logout
  </Button>
</Flex>
